...
homeMenu.querySelector('a').addEventListener('click',function(event){
    event.preventDefault()
...
homeProfileEdit.querySelector('a').addEventListener('click',function(event){
    event.preventDefault()
...
homeProfileEditPassword.addEventListener('submit',function(event){
    event.preventDefault()

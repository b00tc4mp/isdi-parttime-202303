module.exports = {
    ...
    retrieveEmployeeLoggedHandler: require('./retrieveEmployeeLoggedHandler'),
    retrieveEmployeePayrollDataHandler: require('./retrieveEmployeePayrollDataHandler'),
    searchEmployeesHandler: require('./searchEmployeesHandler'),
    ...
    updateEmployeeHandler: require('./updateEmployeeHandler'),

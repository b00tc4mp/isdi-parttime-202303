...
export default function PayrollMonth({ payrollAnnualAggregate, onClosePayrollAnnualAggregateModal }) {
    ...
    const handleClosePayrollAnnualAggregateModal = () => {
        setModal(null)
        onClosePayrollAnnualAggregateModal()
    }
    ...
    return <article className="bg-slate-200">
        <div className="flex flex-col items-end">
            <FormButton className=" w-[6%] mr-[4%] bg-slate-500 text-xs mb-2" onClick={handleClosePayrollAnnualAggregateModal}>Close</FormButton>
        </div>
        <article className="bg-white rounded-[7px] shadow bg-neutral-200">

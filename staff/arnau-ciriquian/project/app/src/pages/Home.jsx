...
const Home = ({ onContinueToNewCharacter }) => {
    ...
    return (
        <View className="flex justify-center items-center h-screen w-screen pt-20">
            <Image source={require('../../assets/home/main-bg.jpg')} className="absolute scale-125 bottom-0" ></Image>
            {!user?.character && <View className="w-80 h-4/5 m-5 justify-around items-center">
            ...
            {user?.character && <View className="flex justify-center items-center h-screen w-screen p-2">

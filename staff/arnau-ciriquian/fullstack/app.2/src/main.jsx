...
/*  TODO Web/App - objectiu de la app: xarxa social:
        - ig d'acudits
                ...
                - peticio app a api -> npm i express a l'API (instalar express) 20230606 2030
                - insomnia api.post 20230606 2052
                - configurar index.js a api per fet els api.get, api.post etc i provar a traves de insomnia 20230606

                - OPTIONAL
                - custom hooks 20230605 2030
                - Si s'ha de passar a common js -> classe 20230605 20:00

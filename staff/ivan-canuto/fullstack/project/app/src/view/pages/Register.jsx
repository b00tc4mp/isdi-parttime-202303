        ...
        <div className='flex justify-center items-center w-11/12'>
            <div className="w-4/5 h-[580px] bg-white rounded-[10px] border border-black flex flex-col items-center justify-center">
                <Form className="flex flex-col gap-4 w-80 items-center mt-2 mb-4" onSubmit={handleRegisterIn}>
                    <img className="max-w-[140px] h-[140px] rounded-full mt-[-130px]" src="src/images/logo-login&register.jpg" />
                    ...
                    <Input className="w-2/3 h-12 border-black border-2 rounded-lg p-4" name='username' placeholder="Userame" />

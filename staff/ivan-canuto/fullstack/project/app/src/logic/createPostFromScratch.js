...
const { validateNewPostTitle, validateNewPostContent } = validators
...
export default function createPost(_title, _content) {
    ...
    return (async () => {
        const res = await fetch(`${import.meta.env.VITE_API_URL}/newPostFromScratch`, {
            method: 'POST',
            headers: {

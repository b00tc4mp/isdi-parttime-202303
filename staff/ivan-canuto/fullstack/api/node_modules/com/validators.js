...
const validateUrl = (newUrl, explanation = 'url')=>{
...
const validateId = (userId, explanation = 'id')=>{
...
const validateText = (text, explanation = 'text')=>{
...
const validateCallback = (callBack, explanation = 'CallBack') => {

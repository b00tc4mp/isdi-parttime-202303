...
import { handleFav } from '../logic/fav-post.js';
import { handleLike } from '../logic/like-post.js';
...
export default function initPostsList(userAuth, modal, type, postContainer = document.querySelector('.posts-list')) {
  ...
  const addPostsList = () => {
    ...
    posts.forEach((post) => {
      ...
      favButton.addEventListener('click', (event) => {
        ...
        try {
          press(favButton)
          const fav = handleFav(post.id, userAuth);
      ...
      likeButton.addEventListener('click', (event) => {
        ...
        try {
          press(likeButton);
          const likes = handleLike(post.id, userAuth);

...
describe('authenticateUser', () => {
    ...
    it('should login a user with correct credentials', async () => {
        ...
        const user = generate.user(username, cryptPassword, 'beach', color, recoveryQuestions, saves, [], [], 100);
    ...
    it('should fail on wrong credentials', async () => {
        ...
        const user = generate.user(username, 'different_password', 'beach', color, recoveryQuestions, [], [], [], 0);

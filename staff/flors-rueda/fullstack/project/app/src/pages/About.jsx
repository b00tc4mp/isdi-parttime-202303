            ...
            <div>
                ...
                <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-3 pt-1">
                    <div className="flex flex-col gap-2 md:gap-5">
                        ...
                        <button className="bg-primary200 self-center md:w-fit max-w-xs w-3/4 px-5 py-2 hover:bg-primary600 text-sm lg:text-md text-light500 hover:text-light400 font-bold rounded-lg transition duration-200"> <a href="https://www.paypal.com/donate/?hosted_button_id=T6RDWW8UWW5L4" target="_blank" rel="noopener noreferrer" >
                            Buy me a <span className="line-through font-semibold">coffe</span> tea<i className="bi bi-cup-hot-fill pl-2"></i>
                        </a></button>
                    </div>

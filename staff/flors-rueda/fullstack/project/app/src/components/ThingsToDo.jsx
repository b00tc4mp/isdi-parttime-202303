...
const ThingsToDo = ({ handleToRegister }) => {
    return (
        <div className="bg-darkShadow w-full px-10 py-5 md:pb-24">
            <h3 className="text-light500 text-xl font-bold mb-4 tracking-wide text-center">Interested in finding the <span className="text-primary600">treasures</span> of <span className="text-primary500">Ballopolis?</span></h3>
            <div className="grid grid-cols-1 grid-rows-4 md:grid-cols-2 md:grid-rows-2 gap-4 lg:grid-cols-4 lg:grid-rows-1">

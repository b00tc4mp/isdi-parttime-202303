        ...
        <div className="flex items-center w-full justify-around">
            {
                ...
                <button
                    ...
                    className={`border-0 bg-none p-0 text-primary100 opacity-${activeIndex === 0 ? 'cursor-default 50 ' : '100 hover:text-primary200'}`}
                >
            ...
            </div>
            {
                ...
                <button
                    ...
                    className={`border-0 bg-none p-0 text-primary100 opacity-${activeIndex < achievements.length - 1 ? '100 hover:text-primary200' : '50 cursor-default'} `}
                >

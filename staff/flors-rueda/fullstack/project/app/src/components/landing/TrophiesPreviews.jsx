...
const TrophiesPreview = () => {
    ...
    return (
        <div className="flex flex-col w-full justify-center align-center bg-dark400 mt-10 py-7">
            <b className="text-primary300 font-serif italic text-center font-bold text-4xl pb-5">EARN TROPHIES</b>

    ...
    return (
        <nav className="flex bg-gray-400/80 z-40 fixed top-0 left-0 w-full h-full backdrop-blur-lg uppercase">
            <ul className="px-4 self-center   [&>*]:font-normal [&>*]:text-3xl">
                ...
                <li><a href="#" onClick={() => handleNavItemClick('register')}>Register</a></li>
                <li  ><a href="#" onClick={() => handleNavItemClick('login')}>Login</a></li>
                <li className="pb-4" ><a href="#" oonClick={() => handleNavItemClick('logout')}>Logout</a></li>

...
const EditUpdateForm = (_id: any) => {
    ...
    useEffect(() => {
        try{
        fetch('http://localhost:4321/updates/'+_id, { cache: 'no-store' })
          .then((res) => res.json())
          .then((data) => {
            setUpdate(data);
            setLoading(false);
            ...
            <div className="flex flex-col content-center">
                ...
                <div className='p-8 justify-center items-center h-fit w-auto flex'>
                    <form className='flex flex-col gap-6 w-full justify-center justify-items-center' onSubmit={onSubmit}>
                        ...
                        <textarea className='bg-gray-200 shadow-inner rounded-l p-2 flex-1 text' id='text' aria-label='text' placeholder='Text' defaultValue={update.text} />

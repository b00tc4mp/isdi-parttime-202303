...
mongoose.connect('mongodb://127.0.0.1:27017/amw')
    ...
    .then(() => {
        ...
        return Promise.all([admin.save(), update.save(), update2.save(), update3.save(), update4.save(), evento.save(), evento2.save(), song.save(), mensaje.save(), mails.save(), redes.save()])
    })
    .catch(error => {
        console.error(error)
    })

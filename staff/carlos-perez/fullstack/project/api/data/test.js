...
mongoose.connect('mongodb://127.0.0.1:27017/amw')
    ...
    .then(() => {
        ...
        const song4 = new LyricPost({ author: admin.id, title: '4Si te tuviera delante', media: 'https://youtu.be/uQDwRdoE67k', text: 'Cantabas Cuando todo el mundo callaba Te daban igual las miradas Cantabas Cuando todo el mundo callaba Te daban igual las miradas', songInfo: 'Autores: Alejandro Lorenzo Botello, Julio Darío De La Rosa Asencio', visibility: true })

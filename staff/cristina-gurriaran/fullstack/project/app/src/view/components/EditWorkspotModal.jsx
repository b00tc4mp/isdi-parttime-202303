                    ...
                    <div className="overflow-auto mx-auto bg-white md:w-1/2 lg:w-2/3 xl:w-2/3 sm:w-full h-2/3 m-20 p-10 rounded-md">
                        <Form className="flex flex-col gap-4" onSubmit={handleEditWorkspot}>
                            ...
                            <Input
                                name="name"
                                placeholder="Name"
                                defaultValue={workspotData.name} />
                            <TextArea
                            ...
                            <Input
                                name="city"
                                placeholder="City"
                                defaultValue={workspotData.location.city} />
                            <Input
                                name="country"
                                placeholder="Country"
                            ...
                            {Object.keys(workspotData.features.otherFeatures).map(otherFeaturesOption => (

...
import { editPostForm } from "../pages/home-page.js"
...
export const containerFooter = document.querySelector('footer .footer-container')
export const footer = document.querySelector('footer')
if(isMobile()) {
    const userIcon = document.createElement('div')
    userIcon.classList.add('user-icon')
    const addPostIcon = document.createElement('div')
    addPostIcon.classList.add('add-post-icon')
    containerFooter.append(userIcon, addPostIcon)
    userIcon.innerHTML = `<div class="material-symbols-outlined">face</div>`
  }

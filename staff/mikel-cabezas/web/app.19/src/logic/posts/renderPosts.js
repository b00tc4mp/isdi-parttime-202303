...
import { renderAllUserLikedPost } from "../../components/helpers/render-all-users-liked-post.js";
import { savePostToFavorites, userLikedPost } from "./posts-data.js";
import { showEditPost } from "../../components/init-edit-post-panel.js";
        ...
        recentPostsFirst.forEach(article => {
            try {
                ...
                if(userId === authorID) {
                    ...
                    editButton.onclick = (event) => showEditPost(article.id, document.querySelector('.posts'), posts)
                }
            } catch (error) {

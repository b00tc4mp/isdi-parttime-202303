...
export default function CreatePlayground({ closeHandle }) {
    ...
    return <>
        <Animatable.View animation={animation} duration={200} className="w-full left-0 absolute bottom-0 h-auto max-h-max py-5 bg-white rounded-[20px] mx-auto min-h-[300px] z-50" >

            <View className="bg-white dark:bg-gray-800 h-auto px-6 py-7  rounded-3xl">
